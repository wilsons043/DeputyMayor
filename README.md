...
- **Rates**: the IRS standard mileage rate in effect on the trip date is applied automatically (72.5 cents through June 30, 2026 and 76 cents from July 1, 2026). Set a custom city rate under **Places, routes and settings** if the city reimburses differently.
